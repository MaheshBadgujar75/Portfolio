...
export const Github: React.FC<Props> = ({
  ...
  >
    <path
      d="M9 19C9 19 9.034 16 12 16C14.966 16 15 19 15 19"
      stroke="currentColor"
      strokeWidth={strokeWidth}
      strokeLinecap="square"
    />
...
export const Cpu: React.FC<Props> = ({
  size = 24,
  className = "",
  strokeWidth = 1.5,
}) => (
...
export const Zap: React.FC<Props> = ({
  size = 24,
  className = "",
  strokeWidth = 1.5,
}) => (
...
export const Server: React.FC<Props> = ({
  size = 24,
  className = "",
  strokeWidth = 1.5,
}) => (
