...
const ProjectListItem: React.FC<ProjectListItemProps> = ({
  ...
  return (
    <div
      ...
      className={`group relative py-12 px-4 md:px-12 border-b border-white/10 cursor-pointer transition-colors duration-500 ${
    ...
    >
      <div className="flex items-baseline justify-between relative z-10">
        <div className="flex items-baseline gap-6 md:gap-12">
          ...
          <h2
            className={`text-4xl md:text-6xl font-heading font-bold uppercase tracking-tighter transition-all duration-300 ${
              isActive
      ...
      <div
        className={`mt-4 ml-[calc(1.5rem+12px)] md:ml-[calc(3rem+24px)] overflow-hidden transition-all duration-500 ${
