          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-white/10 pb-8">
            <div>
              ...
              >
                ...
                <span className="text-xs font-mono font-bold text-green-500 uppercase tracking-widest">
                  Lets Build Together
                </span>
              </motion.div>
              <motion.h1
            ...
            >
              <div className="text-sm font-mono text-slate-500 uppercase tracking-widest mb-1">
                Local Time (India)
              </div>
              <TimeDisplay />
            </motion.div>
              ...
              {isSuccess ? (
                ...
                >
                  ...
                  <p className="text-slate-400 text-lg mb-12 max-w-md">
                    I've received your signal. Expect a response on your secure
                ...
                >
                  ...
                  <div className="md:pl-12 space-y-16 md:space-y-24">
                    ...
                    >
                      <label className="block text-xs font-mono text-primary uppercase tracking-widest mb-4">
                        01 // Identity
                      </label>
                      <input
                      ...
                      />
                      {errors.name && (
                        <span className="absolute -bottom-6 left-0 text-xs text-primary font-mono">
                          Field Required
                        </span>
                      )}
                    </div>
                    ...
                    >
                      ...
                      >
                        <option value="" className="bg-dark text-slate-500">
                          Select Project Type
                        </option>
                        <option value="web" className="bg-dark text-white">
                          Web Development
                        </option>
                        <option value="mobile" className="bg-dark text-white">
                          Mobile Application
                        </option>
                        <option
                          value="automation"
...
const ContactCard: React.FC<ContactCardProps> = ({
  ...
  const Content = (
    <div className="bg-white/5 border border-white/10 p-6 rounded-xl hover:bg-white/10 hover:border-primary/50 transition-all group cursor-pointer relative overflow-hidden">
      ...
      <div className="text-lg font-bold text-white break-all relative z-10">
        {value}
      </div>
  ...
  return href ? (
    <a href={href} onClick={handleAction} className="block">
      {Content}
    </a>
  ) : (
    <div onClick={handleAction} className="block">
      {Content}
    </div>
  );
};
