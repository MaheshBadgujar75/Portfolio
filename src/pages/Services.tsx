...
const SERVICE_IMAGES: Record<string, string> = {
  ...
  "api-dev":
    "https://images.unsplash.com/photo-1558494949-ef2cb3cc30e1?q=80&w=2070&auto=format&fit=crop",
};
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="mb-20 relative">
          <motion.h1
            ...
            className="text-[12vw] leading-[0.8] font-heading font-bold text-white/5 select-none pointer-events-none absolute top-[-5vw] left-0 -z-10 whitespace-nowrap"
          >
            CAPABILITIES
          </motion.h1>
          <motion.div
...
const ServiceSlab = ({ service, index, isActive, onClick }: any) => {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`group relative border bg-zinc-900/40 backdrop-blur-md overflow-hidden transition-all duration-500 cursor-pointer ${
        isActive
      ...
      <div className="relative z-10 p-6 md:p-10 flex flex-col h-full">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6 md:gap-12">
            ...
            <h3
              className={`text-2xl md:text-5xl font-heading font-bold transition-all duration-500 ${
                isActive
                ...
                <div className="order-1 md:order-2 relative h-64 md:h-auto bg-black rounded-xl border border-white/10 flex items-center justify-center overflow-hidden group/visual shadow-2xl">
                  ...
                  >
                    <Icon
                      strokeWidth={1.5}
                      size={48}
                      className="text-white group-hover/visual:text-primary transition-colors duration-300"
                    />
                  </motion.div>
