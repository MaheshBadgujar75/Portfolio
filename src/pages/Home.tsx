        ...
        >
          <div className="overflow-hidden">
            <motion.h1
              ...
              className="text-[13vw] md:text-[10vw] font-heading font-bold leading-none tracking-tighter text-white"
            >
              FULL STACK
            </motion.h1>
          </div>
          ...
          >
            <div className="flex items-center gap-3 md:justify-end mb-2">
              ...
              <span className="text-xs font-mono text-white font-bold bg-white/10 px-3 py-1 rounded-full uppercase tracking-widest hover:bg-white/20 transition-colors cursor-default">
                Available For Work
              </span>
            </div>
            <h2 className="text-4xl md:text-5xl font-heading font-bold text-slate-200 leading-none tracking-tight">
              MAHESH
              <br />
